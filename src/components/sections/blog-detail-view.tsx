...
function ArticleBody({ article }: { article: CmsArticle }) {
  // Prefer CMS/HTML content over static i18n sections (sections were a fallback).
  if (article.content?.trim()) {
    const looksLikeHtml = /<\/?[a-z][\s\S]*>/i.test(article.content);
    if (looksLikeHtml) {
      return (
        <div
          className="article-prose mx-auto max-w-3xl space-y-6 text-base leading-relaxed text-muted-foreground md:text-lg [&_a]:text-glow [&_a]:underline-offset-4 hover:[&_a]:underline [&_blockquote]:border-l-2 [&_blockquote]:border-border [&_blockquote]:pl-4 [&_blockquote]:italic [&_h2]:mt-12 [&_h2]:font-display [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-foreground [&_h3]:mt-8 [&_h3]:font-display [&_h3]:text-xl [&_h3]:font-bold [&_h3]:text-foreground [&_img]:my-8 [&_img]:block [&_img]:h-auto [&_img]:max-w-full [&_img]:rounded-2xl [&_img]:border [&_img]:border-border/70 [&_img[data-align=center]]:mx-auto [&_img[data-align=left]]:mr-auto [&_img[data-align=left]]:ml-0 [&_img[data-align=right]]:ml-auto [&_img[data-align=right]]:mr-0 [&_img:not([data-align])]:mx-auto [&_mark]:rounded-sm [&_mark]:bg-amber-200/70 [&_mark]:px-0.5 [&_mark]:text-foreground [&_ol]:my-4 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:leading-relaxed [&_strong]:text-foreground [&_table]:my-8 [&_table]:w-full [&_table]:border-collapse [&_table]:overflow-hidden [&_table]:rounded-xl [&_table]:border [&_table]:border-border [&_td]:border [&_td]:border-border [&_td]:px-3 [&_td]:py-2 [&_td]:align-top [&_th]:border [&_th]:border-border [&_th]:bg-secondary/60 [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:font-semibold [&_th]:text-foreground [&_u]:underline [&_ul]:my-4 [&_ul]:list-disc [&_ul]:pl-5 [&_li]:my-1"
